...
namespace kantech2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // read from config
            //services.AddScoped<ISimpleFacade, SimpleFacade>();
            //services.AddTransient<ISimpleFacade, SimpleFacade>();

            if (Configuration.GetSection("UseMicroServices").Value == "True")
                services.AddSingleton<ISimpleFacade, MicroSimpleFacade>();
            else
                services.AddSingleton<ISimpleFacade, SimpleFacade>();
        }
